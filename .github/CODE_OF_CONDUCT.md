...
## :mag_right: Scope
This Code of Conduct applies to all sections of the [RLCraft Wiki repository](https://github.com/ValMobile/RLCraft-Wiki), our [RLCraft GitHub organization](https://github.com/ValMobile/RLCraft) and all repositories owned by said organization.<br>
For our official Discord server, please refer to our article on [Discord Rules](https://github.com/ValMobile/RLCraft/wiki/Discord-Rules).
...
Issues that are considered "good first issues", indicated by the [good first issue](https://github.com/ValMobile/RLCraft-Wiki/labels/good%20first%20issue) label, are generally expected to be beginner-friendly. 
And even if you shouldn't know where to start or how to proceed, our [Discord Server](https://github.com/ValMobile/RLCraft#discord) and its community will be there for you!
...
You can see a list of people who are recognized as "project maintainers" for RLCraft on the RLCraft GitHub organization:<br>
https://github.com/orgs/ValMobile/people

## :wrench: Enforcement
Instances of abusive, harassing, or otherwise unacceptable behavior may be
reported to the community leaders (labelled on Discord as "Admins" or "Moderators") responsible for enforcement on our [Discord Server](https://github.com/ValMobile/RLCraft#discord).
