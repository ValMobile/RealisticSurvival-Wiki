If you have just started using Realistic Survival, it may seem complicated.
...
## 1. The Flint Age
You can no longer break trees with your bare fists, so you'll have to get wood by creating flint tools. First, find some gravel. Gravel is commonly found near water sources or underwater. Dig it until you get flint.<br><br>
<img src="https://raw.githubusercontent.com/ValMobile/RealisticSurvival-Wiki/master/images/gravel-block.png" width="231" height="161" alt="Gravel Block"/>

From there, left-click the flint on a stone block to break it into flint shards.<br><br>
<img src="https://raw.githubusercontent.com/ValMobile/RealisticSurvival-Wiki/master/images/hitting-flint-on-stone.png" width="214" height="226" alt="Hitting flint on stone"/>
...
These methods of acquiring wooden planks and sticks are not only annoying but also inefficient.
To get the full yield, craft a saw and then place the saw and logs/planks into the crafting grid to acquire planks/sticks.

## 2. Managing Tough As Nails
You should notice a new temperature circle and thirst bar in your HUD, which displays your temperature and thirst.<br><br>
<img src="https://raw.githubusercontent.com/ValMobile/RealisticSurvival-Wiki/master/images/temperature-thirst-bar.png" width="244" height="71" alt="Temperature and thirst bar"/>
...
to acquire some [Spartan weapons](https://github.com/ValMobile/RealisticSurvival/wiki/Spartan-Weaponry).

To craft them, first create handles.<br>
...
<img src="https://raw.githubusercontent.com/ValMobile/RealisticSurvival-Wiki/master/images/handle-wool-recipe.png" width="248" height="140" alt="Handle wool recipe"/><br><br>
Poles are needed for certain recipes. Their recipes are shown below.<br>
...
Once you acquire handles and poles, you can begin crafting Spartan weapons. Spartan weapons are made from the same materials as their vanilla counterparts (wood, stone, iron, etc).
Detailed information on Spartan weapons, including their stats, can be found [here](https://github.com/ValMobile/RealisticSurvival/wiki/Spartan-Weaponry).

## 4. Getting Baubles
If you've explored and fought numerous mobs, you might have stumbled upon a rare material called <img src="https://raw.githubusercontent.com/ValMobile/RealisticSurvival-Wiki/master/images/spectral-silt-item.png" width="16" height="16" alt="Spectral silt item"/> spectral silt.  
Imbued with magical properties, spectral silt allows the player to craft powerful baubles.

To harness the power of a bauble, you'll have to equip it in a bauble bag. You can craft it as shown below.<br><br>
...
|      **Slot**       |      ![Amulet Slot](https://raw.githubusercontent.com/ValMobile/RealisticSurvival-Wiki/master/images/amulet-slot-item.png) Amulet       | ![Belt Slot](https://raw.githubusercontent.com/ValMobile/RealisticSurvival-Wiki/master/images/belt-slot-item.png) Belt |           ![Body Slot](https://raw.githubusercontent.com/ValMobile/RealisticSurvival-Wiki/master/images/body-slot-item.png) Body           | ![Charm Slot](https://raw.githubusercontent.com/ValMobile/RealisticSurvival-Wiki/master/images/charm-slot-item.png) Charm |     ![Head Slot](https://raw.githubusercontent.com/ValMobile/RealisticSurvival-Wiki/master/images/head-slot-item.png) Head     |                  ![Ring Slot](https://raw.githubusercontent.com/ValMobile/RealisticSurvival-Wiki/master/images/ring-slot-item.png) Ring                   |
|:-------------------:|:---------------------------------------------------------------------------------------------------------------------------------------:|:----------------------------------------------------------------------------------------------------------------------:|:------------------------------------------------------------------------------------------------------------------------------------------:|:-------------------------------------------------------------------------------------------------------------------------:|:------------------------------------------------------------------------------------------------------------------------------:|:---------------------------------------------------------------------------------------------------------------------------------------------------------:|
 | **Example Baubles** | ![Wrath Pendant](https://raw.githubusercontent.com/ValMobile/RealisticSurvival-Wiki/master/images/wrath-pendant-item.png) Wrath Pendant |                                                     None currently                                                     | ![Shield of Honor](https://raw.githubusercontent.com/ValMobile/RealisticSurvival-Wiki/master/images/shield-honor-item.png) Shield of Honor |                                                      None currently                                                       | ![Sunglasses](https://raw.githubusercontent.com/ValMobile/RealisticSurvival-Wiki/master/images/sunglasses-item.png) Sunglasses | ![Potion Ring of Speed](https://raw.githubusercontent.com/ValMobile/RealisticSurvival-Wiki/master/images/potion-ring-speed-item.png) Potion Ring of Speed | 
...
Since sea serpent attacks are most lethal at close range, players should use ranged weapons like boomerangs and longbows to safely damage the sea serpent.

Note that sea serpents currently do not have any custom attacks. Their AI and appearance are exactly like that of vanilla elder guardians, so any strategies used to defeat elder guardians will work for sea serpents.
This is subject to change in the future, however.
...
## 6. Slaying Dragons
The vanilla ender dragon has been replaced with a more formidable boss called the dragon. Dragons have three breeds, each of which are subdivided into four variants.

### Combat Strategies
It is recommended to have at least enchanted diamond armor, preferably netherite, and a completely filled bauble bag.
Dragons have the same attacks as ender dragons with the addition of two special ones, breath and explosion.
